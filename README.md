# jdm-expo-api-gateway
Single entry point and API routing gateway built with Spring Cloud Gateway for managing external traffic across the JDM Expo platform.<br>
